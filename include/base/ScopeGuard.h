...
#define COMMUNICATIONS_CONCATENATE_DIRECT(s1, s2)  s1##s2
#define COMMUNICATIONS_CONCATENATE(s1, s2)         COMMUNICATIONS_CONCATENATE_DIRECT(s1, s2)
#define COMMUNICATIONS_ANONYMOUS_VARIABLE(str)     COMMUNICATIONS_CONCATENATE(str, __LINE__)

#define COMMUNICATIONS_GUARD(...)      Communications::ScopeGuard COMMUNICATIONS_ANONYMOUS_VARIABLE(scopeGuard) = Communications::MakeGuard(__VA_ARGS__); ((void)COMMUNICATIONS_ANONYMOUS_VARIABLE(scopeGuard))
#define COMMUNICATIONS_GUARD_OBJ(...)  Communications::ScopeGuard COMMUNICATIONS_ANONYMOUS_VARIABLE(scopeGuard) = Communications::MakeObjGuard(__VA_ARGS__); ((void)COMMUNICATIONS_ANONYMOUS_VARIABLE(scopeGuard))
